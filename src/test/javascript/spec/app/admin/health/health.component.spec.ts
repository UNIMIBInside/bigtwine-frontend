...
import { BtwHealthCheckComponent } from 'app/admin/health/health.component';
import { BtwHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('BtwHealthCheckComponent', () => {
        let comp: BtwHealthCheckComponent;
        let fixture: ComponentFixture<BtwHealthCheckComponent>;
        let service: BtwHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [BigtwineTestModule],
                declarations: [BtwHealthCheckComponent]
            })
                .overrideTemplate(BtwHealthCheckComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(BtwHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(BtwHealthService);
        });
